...
description: A diversity index is a way to measure the prevalence of different species in an ecosystem. I show how methods from the price-index literature can be used to decompose a diversity index into the contribution of each species towards overall diversity.
---
...
The core tool to do this comes from my [`{gpindex}`](https://marberts.github.io/gpindex) package.
