...
description: Hedonic imputation is a standard method to compares prices over time when the composition of products also changes. In all cases I've seenm, the method is implemented by using the fitted values from two regression models. I show how it can be done with one regression.
---
