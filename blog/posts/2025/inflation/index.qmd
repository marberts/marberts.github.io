...
description: Long-term inflation requires something that increase prices and grow without bound (i.e., money supply). I show that the way that inflation is measured can itself be a source of inflation.
---
...
Both components of the chained index—the first and last change in price and the part due to oscillations—show no change in price.
