...
::: {.column-margin}
[![](img/pysps.png){width=50%}](https://marberts.github.io/pysps)
:::
...
I've made several (usually) small contributions to various open source projects.
...
[{gseries}](https://cran.r-project.org/package=gseries)
